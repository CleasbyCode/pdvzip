...
static void updateValue(std::vector<uint8_t>& vec, uint32_t insert_index, const uint32_t NEW_VALUE, uint8_t bits, bool isBigEndian) {
	while (bits) {
...
static void resizeImage(std::vector<uint8_t>& image_file_vec) {
