...
CXXFLAGS="-std=c++23 -O3 -mtune=native -pipe -Wall -Wextra -Wpedantic -Wshadow -DNDEBUG -D_FORTIFY_SOURCE=3 -DLODEPNG_NO_COMPILE_DISK -DLODEPNG_NO_COMPILE_ANCILLARY_CHUNKS -DLODEPNG_NO_COMPILE_CRC -s -flto=auto $LINKER_PLUGIN_FLAG -fstack-protector-strong -fPIE"
