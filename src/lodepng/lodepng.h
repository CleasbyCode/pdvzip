...
/*#define LODEPNG_COMPILE_DISK*/ /*disabled for pdvzip: we handle our own file I/O*/
#endif
...
/*#define LODEPNG_COMPILE_ANCILLARY_CHUNKS*/ /*disabled for pdvzip: iCCP chunk built manually, no other ancillary chunks needed*/
#endif
