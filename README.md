# pdvzip
A simple command-line tool used for embedding a **ZIP** file within a PNG image to create  
a *tweetable* and *"executable"* **PNG-ZIP** polyglot file.  
...
**pdvzip** uses different methods for [***storing***](https://github.com/CleasbyCode/pdvzip#png-image-requirements-for-arbitrary-data-preservation) and [***accessing***](https://github.com/CleasbyCode/pdvzip#extracting-your-embedded-files) embedded files within a PNG image file.  
