# pdvzip
CLI tool used to embed a ZIP file within a PNG image, creating a *tweetable* and "[*executable*](https://github.com/CleasbyCode/pdvzip#extracting-your-embedded-files)" PNG-ZIP polyglot image file.  
