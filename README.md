...
{***Image demo: Download and*** [**run me**](https://github.com/CleasbyCode/pdvzip#extracting-your-embedded-files) ***to play embedded video clip.***} ***(Credit: Djohn Coper, "Joker", [original image link)***](https://creator.nightcafe.studio/creation/U9WrKXRrmfatrg3eayUf)  
