...
**With ***pdvzip***, you can embed a single ZIP file up to a maximum size of ~1GB. Compatible hosting sites, listed below, have their own, much smaller size limits (cover image + archive file):**
