...
\**If the embedded image is over **5MB** (when using the **--imgur** option) I would **not recommend**  
posting the image to the **Imgur Community Page**, as the thumbnail preview fails and shows as a broken icon image.  
